...
android {
    ...
    defaultConfig {
        applicationId = "com.streamready.tv"
        ...
        buildConfigField("String", "GITHUB_OWNER", "\"n3xtss\"")
        buildConfigField("String", "GITHUB_REPO", "\"StreamReadyTV\"")
    }
    ...
    productFlavors {
        ...
        create("playstore") {
            dimension = "distribution"
            applicationId = "com.streamready.app"
...
androidComponents {
    onVariants(selector().withBuildType("debug")) { variant ->
        ...
        variant.applicationId.set(if (isPlaystore) "com.streamready.app.debug" else "com.streamready.tv.debug")
    }
}
